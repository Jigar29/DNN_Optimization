...
function predicted_label = predictLabel( layer1_weights, layer2_weights, data, activation_array_fptr)
    ...
    layer1_output = activation_array_fptr(([ones(size_of_input, 1) data] * layer1_weights'));
    
    %predicting the final output after layer 2
    layer2_output = activation_array_fptr(([ones(size_of_input, 1) layer1_output] * layer2_weights'));
