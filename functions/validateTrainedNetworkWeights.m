...
%Returns        : No returns 
function validateTrainedNetworkWeights(lambda, bit_scheme_array_fptr, activation_array_fptr, activation_gradient_fptr)
    ...
    costFunc = @(p) trainTheModel(data, labels, p, num_input_features, num_hidden_layers, num_labels,lambda, bit_scheme_array_fptr, activation_array_fptr, activation_gradient_fptr);
