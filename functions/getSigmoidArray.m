...
function sigmoid_value_array = getSigmoidArray(input_array, bit_scheme_number_fptr)
    ...
    for i=1:row
        for j =1:col
            sigmoid_value_array(i, j) = getSigmoidValue(input_array(i,j), bit_scheme_number_fptr);
        end
    end
end
